...
// checks if the CSEWindowsErrorTracker type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CSEWindowsErrorTracker{}
...
func (o CSEWindowsErrorTracker) ToMap() (map[string]interface{}, error) {
