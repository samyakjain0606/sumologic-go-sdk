...
func (o *CriticalPathServiceBreakdownElementDetail) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varCriticalPathServiceBreakdownElementDetail)
