...
func (o *LogSearchNotificationThresholdSyncDefinition) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varLogSearchNotificationThresholdSyncDefinition)
