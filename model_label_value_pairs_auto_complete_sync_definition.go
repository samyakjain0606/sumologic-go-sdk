...
func (o *LabelValuePairsAutoCompleteSyncDefinition) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varLabelValuePairsAutoCompleteSyncDefinition)
