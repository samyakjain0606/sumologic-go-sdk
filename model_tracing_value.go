...
// checks if the TracingValue type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TracingValue{}
...
func (o *TracingValue) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varTracingValue)
