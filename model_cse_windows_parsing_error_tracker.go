...
// checks if the CSEWindowsParsingErrorTracker type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CSEWindowsParsingErrorTracker{}
...
func (o CSEWindowsParsingErrorTracker) ToMap() (map[string]interface{}, error) {
