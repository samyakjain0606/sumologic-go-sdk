...
// checks if the FieldName type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FieldName{}
...
func (o FieldName) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["fieldName"] = o.FieldName
	return toSerialize, nil
}

func (o *FieldName) UnmarshalJSON(bytes []byte) (err error) {
	...
	varFieldName := _FieldName{}

	err = json.Unmarshal(bytes, &varFieldName)

	if err != nil {
		return err
	}

	*o = FieldName(varFieldName)
