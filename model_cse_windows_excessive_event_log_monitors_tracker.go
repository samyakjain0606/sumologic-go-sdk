...
func (o *CSEWindowsExcessiveEventLogMonitorsTracker) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varCSEWindowsExcessiveEventLogMonitorsTracker)
