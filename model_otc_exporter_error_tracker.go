...
// checks if the OTCExporterErrorTracker type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OTCExporterErrorTracker{}
...
func (o OTCExporterErrorTracker) ToMap() (map[string]interface{}, error) {
