...
func (o *MetricsMetadataKeyValuePairsLimitExceededTracker) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varMetricsMetadataKeyValuePairsLimitExceededTracker)
