...
// checks if the MutingSchedulesLibraryBaseResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MutingSchedulesLibraryBaseResponse{}

// MutingSchedulesLibraryBaseResponse struct for MutingSchedulesLibraryBaseResponse
type MutingSchedulesLibraryBaseResponse struct {
	// Identifier of the mutingschedule or folder.
	Id string `json:"id"`
	// Identifier of the mutingschedule or folder.
	Name string `json:"name"`
	// Description of the mutingschedule or folder.
	Description string `json:"description"`
	// Version of the mutingschedule or folder.
	...
	// Type of the content. Valid values:   1) Mutingschedule   2) Folder
...
func NewMutingSchedulesLibraryBaseResponse(id string, name string, description string, version int64, createdAt time.Time, createdBy string, modifiedAt time.Time, modifiedBy string, parentId string, contentType string, type_ string, isSystem bool, isMutable bool) *MutingSchedulesLibraryBaseResponse {
	this := MutingSchedulesLibraryBaseResponse{}
	this.Id = id
	this.Name = name
...
func (o MutingSchedulesLibraryBaseResponse) MarshalJSON() ([]byte, error) {
...
func (o MutingSchedulesLibraryBaseResponse) ToMap() (map[string]interface{}, error) {
...
func (o *MutingSchedulesLibraryBaseResponse) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varMutingSchedulesLibraryBaseResponse)
...
type NullableMutingSchedulesLibraryBaseResponse struct {
	value *MutingSchedulesLibraryBaseResponse
	isSet bool
}

func (v NullableMutingSchedulesLibraryBaseResponse) Get() *MutingSchedulesLibraryBaseResponse {
	return v.value
}

func (v *NullableMutingSchedulesLibraryBaseResponse) Set(val *MutingSchedulesLibraryBaseResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableMutingSchedulesLibraryBaseResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableMutingSchedulesLibraryBaseResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMutingSchedulesLibraryBaseResponse(val *MutingSchedulesLibraryBaseResponse) *NullableMutingSchedulesLibraryBaseResponse {
	return &NullableMutingSchedulesLibraryBaseResponse{value: val, isSet: true}
}

func (v NullableMutingSchedulesLibraryBaseResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMutingSchedulesLibraryBaseResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
