...
func (o *CollectionAffectedDueToIngestBudgetTracker) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varCollectionAffectedDueToIngestBudgetTracker)
