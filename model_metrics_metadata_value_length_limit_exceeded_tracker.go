...
func (o *MetricsMetadataValueLengthLimitExceededTracker) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varMetricsMetadataValueLengthLimitExceededTracker)
