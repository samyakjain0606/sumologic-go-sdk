...
// GroupDefinition One Group key and the values for muting schedule.
...
func (o *GroupDefinition) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varGroupDefinition)
