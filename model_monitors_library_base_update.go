...
// checks if the MonitorsLibraryBaseUpdate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MonitorsLibraryBaseUpdate{}
...
type _MonitorsLibraryBaseUpdate MonitorsLibraryBaseUpdate
...
func (o MonitorsLibraryBaseUpdate) ToMap() (map[string]interface{}, error) {
...
func (o *MonitorsLibraryBaseUpdate) UnmarshalJSON(bytes []byte) (err error) {
	...
	varMonitorsLibraryBaseUpdate := _MonitorsLibraryBaseUpdate{}

	err = json.Unmarshal(bytes, &varMonitorsLibraryBaseUpdate)

	if err != nil {
		return err
	}

	*o = MonitorsLibraryBaseUpdate(varMonitorsLibraryBaseUpdate)
