...
func (o *CSEWindowsWriteQueueFilesToSensorDirectoryFailedTracker) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varCSEWindowsWriteQueueFilesToSensorDirectoryFailedTracker)
