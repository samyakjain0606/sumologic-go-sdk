...
func (o *MonitorTemplatesLibraryMonitorTemplateResponse) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varMonitorTemplatesLibraryMonitorTemplateResponse)
