...
// checks if the CSEWindowsSensorOutOfStorageTracker type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CSEWindowsSensorOutOfStorageTracker{}
...
func (o CSEWindowsSensorOutOfStorageTracker) ToMap() (map[string]interface{}, error) {
