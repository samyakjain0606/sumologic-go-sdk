...
func (o *CollectionCloudWatchGetStatisticsDeniedTracker) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varCollectionCloudWatchGetStatisticsDeniedTracker)
