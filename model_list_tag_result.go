...
type _ListTagResult ListTagResult
...
func (o *ListTagResult) UnmarshalJSON(bytes []byte) (err error) {
	...
	varListTagResult := _ListTagResult{}

	err = json.Unmarshal(bytes, &varListTagResult)

	if err != nil {
		return err
	}

	*o = ListTagResult(varListTagResult)
