...
var _ MappedNullable = &OTCProcessSpansRefusedTracker{}
...
func (o OTCProcessSpansRefusedTracker) ToMap() (map[string]interface{}, error) {
...
func (o *OTCProcessSpansRefusedTracker) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varOTCProcessSpansRefusedTracker)
