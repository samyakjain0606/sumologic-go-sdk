...
// checks if the ListIngestBudgetsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListIngestBudgetsResponse{}
...
type _ListIngestBudgetsResponse ListIngestBudgetsResponse
...
func (o ListIngestBudgetsResponse) ToMap() (map[string]interface{}, error) {
...
func (o *ListIngestBudgetsResponse) UnmarshalJSON(bytes []byte) (err error) {
	...
	varListIngestBudgetsResponse := _ListIngestBudgetsResponse{}

	err = json.Unmarshal(bytes, &varListIngestBudgetsResponse)

	if err != nil {
		return err
	}

	*o = ListIngestBudgetsResponse(varListIngestBudgetsResponse)
