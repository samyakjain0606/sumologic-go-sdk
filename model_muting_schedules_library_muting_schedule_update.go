...
func (o *MutingSchedulesLibraryMutingScheduleUpdate) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varMutingSchedulesLibraryMutingScheduleUpdate)
