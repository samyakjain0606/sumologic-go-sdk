...
// checks if the GetCollectorsUsageResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetCollectorsUsageResponse{}
...
type _GetCollectorsUsageResponse GetCollectorsUsageResponse
...
func (o GetCollectorsUsageResponse) ToMap() (map[string]interface{}, error) {
...
func (o *GetCollectorsUsageResponse) UnmarshalJSON(bytes []byte) (err error) {
	...
	varGetCollectorsUsageResponse := _GetCollectorsUsageResponse{}

	err = json.Unmarshal(bytes, &varGetCollectorsUsageResponse)

	if err != nil {
		return err
	}

	*o = GetCollectorsUsageResponse(varGetCollectorsUsageResponse)
