...
func (o *CollectionAwsMetadataTagsFetchDeniedTracker) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varCollectionAwsMetadataTagsFetchDeniedTracker)
