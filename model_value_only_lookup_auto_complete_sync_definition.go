...
func (o *ValueOnlyLookupAutoCompleteSyncDefinition) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varValueOnlyLookupAutoCompleteSyncDefinition)
