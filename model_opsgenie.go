...
func (o *Opsgenie) UnmarshalJSON(bytes []byte) (err error) {
	...
	varOpsgenie := _Opsgenie{}

	err = json.Unmarshal(bytes, &varOpsgenie)

	if err != nil {
		return err
	}

	*o = Opsgenie(varOpsgenie)
