...
func (o *LogSearchQueryParameterSyncDefinitionBase) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varLogSearchQueryParameterSyncDefinitionBase)
