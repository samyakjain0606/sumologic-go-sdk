...
type _AppItemsList AppItemsList
...
func (o *AppItemsList) UnmarshalJSON(bytes []byte) (err error) {
	...
	varAppItemsList := _AppItemsList{}

	err = json.Unmarshal(bytes, &varAppItemsList)

	if err != nil {
		return err
	}

	*o = AppItemsList(varAppItemsList)
