...
type _CollectionCloudWatchTagsFetchDeniedTracker CollectionCloudWatchTagsFetchDeniedTracker
...
func (o *CollectionCloudWatchTagsFetchDeniedTracker) UnmarshalJSON(bytes []byte) (err error) {
	...
	varCollectionCloudWatchTagsFetchDeniedTracker := _CollectionCloudWatchTagsFetchDeniedTracker{}

	err = json.Unmarshal(bytes, &varCollectionCloudWatchTagsFetchDeniedTracker)

	if err != nil {
		return err
	}

	*o = CollectionCloudWatchTagsFetchDeniedTracker(varCollectionCloudWatchTagsFetchDeniedTracker)
