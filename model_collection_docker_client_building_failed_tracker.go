...
func (o *CollectionDockerClientBuildingFailedTracker) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varCollectionDockerClientBuildingFailedTracker)
