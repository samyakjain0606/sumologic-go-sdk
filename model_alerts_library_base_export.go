...
type _AlertsLibraryBaseExport AlertsLibraryBaseExport
...
func (o *AlertsLibraryBaseExport) UnmarshalJSON(bytes []byte) (err error) {
	...
	varAlertsLibraryBaseExport := _AlertsLibraryBaseExport{}

	err = json.Unmarshal(bytes, &varAlertsLibraryBaseExport)

	if err != nil {
		return err
	}

	*o = AlertsLibraryBaseExport(varAlertsLibraryBaseExport)
