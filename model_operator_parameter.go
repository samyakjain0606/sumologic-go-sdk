...
type _OperatorParameter OperatorParameter
...
func (o *OperatorParameter) UnmarshalJSON(bytes []byte) (err error) {
	...
	varOperatorParameter := _OperatorParameter{}

	err = json.Unmarshal(bytes, &varOperatorParameter)

	if err != nil {
		return err
	}

	*o = OperatorParameter(varOperatorParameter)
