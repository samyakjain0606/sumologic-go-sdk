...
func (o *DataPoints) UnmarshalJSON(bytes []byte) (err error) {
	...
	varDataPoints := _DataPoints{}

	err = json.Unmarshal(bytes, &varDataPoints)

	if err != nil {
		return err
	}

	*o = DataPoints(varDataPoints)
