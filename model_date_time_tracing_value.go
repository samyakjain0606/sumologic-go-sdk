...
var _ MappedNullable = &DateTimeTracingValue{}
...
func (o DateTimeTracingValue) ToMap() (map[string]interface{}, error) {
...
func (o *DateTimeTracingValue) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varDateTimeTracingValue)
