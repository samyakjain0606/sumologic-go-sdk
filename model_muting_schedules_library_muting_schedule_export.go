...
func (o *MutingSchedulesLibraryMutingScheduleExport) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varMutingSchedulesLibraryMutingScheduleExport)
