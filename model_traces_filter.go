...
type _TracesFilter TracesFilter
...
func (o *TracesFilter) UnmarshalJSON(bytes []byte) (err error) {
	...
	varTracesFilter := _TracesFilter{}

	err = json.Unmarshal(bytes, &varTracesFilter)

	if err != nil {
		return err
	}

	*o = TracesFilter(varTracesFilter)
