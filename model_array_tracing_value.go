...
type _ArrayTracingValue ArrayTracingValue
...
func (o *ArrayTracingValue) UnmarshalJSON(bytes []byte) (err error) {
	...
	varArrayTracingValue := _ArrayTracingValue{}

	err = json.Unmarshal(bytes, &varArrayTracingValue)

	if err != nil {
		return err
	}

	*o = ArrayTracingValue(varArrayTracingValue)
