...
func (o *ListUserId) UnmarshalJSON(bytes []byte) (err error) {
	...
	varListUserId := _ListUserId{}

	err = json.Unmarshal(bytes, &varListUserId)

	if err != nil {
		return err
	}

	*o = ListUserId(varListUserId)
