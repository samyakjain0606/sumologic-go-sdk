...
// checks if the PanelItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PanelItem{}
...
func (o PanelItem) ToMap() (map[string]interface{}, error) {
...
func (o *PanelItem) UnmarshalJSON(bytes []byte) (err error) {
	...
	varPanelItem := _PanelItem{}

	err = json.Unmarshal(bytes, &varPanelItem)

	if err != nil {
		return err
	}

	*o = PanelItem(varPanelItem)
