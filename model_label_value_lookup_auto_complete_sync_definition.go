...
func (o *LabelValueLookupAutoCompleteSyncDefinition) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varLabelValueLookupAutoCompleteSyncDefinition)
