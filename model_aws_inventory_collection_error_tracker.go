...
// checks if the AwsInventoryCollectionErrorTracker type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AwsInventoryCollectionErrorTracker{}
...
func (o AwsInventoryCollectionErrorTracker) ToMap() (map[string]interface{}, error) {
