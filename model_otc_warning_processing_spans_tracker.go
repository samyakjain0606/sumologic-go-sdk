...
type _OTCWarningProcessingSpansTracker OTCWarningProcessingSpansTracker
...
func NewOTCWarningProcessingSpansTracker(trackerId string, error_ string, description string) *OTCWarningProcessingSpansTracker {
	this := OTCWarningProcessingSpansTracker{}
...
func (o *OTCWarningProcessingSpansTracker) UnmarshalJSON(bytes []byte) (err error) {
	...
	varOTCWarningProcessingSpansTracker := _OTCWarningProcessingSpansTracker{}

	err = json.Unmarshal(bytes, &varOTCWarningProcessingSpansTracker)

	if err != nil {
		return err
	}

	*o = OTCWarningProcessingSpansTracker(varOTCWarningProcessingSpansTracker)

	return err
}

type NullableOTCWarningProcessingSpansTracker struct {
	value *OTCWarningProcessingSpansTracker
	isSet bool
}

func (v NullableOTCWarningProcessingSpansTracker) Get() *OTCWarningProcessingSpansTracker {
	return v.value
}

func (v *NullableOTCWarningProcessingSpansTracker) Set(val *OTCWarningProcessingSpansTracker) {
	v.value = val
	v.isSet = true
}

func (v NullableOTCWarningProcessingSpansTracker) IsSet() bool {
	return v.isSet
}

func (v *NullableOTCWarningProcessingSpansTracker) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOTCWarningProcessingSpansTracker(val *OTCWarningProcessingSpansTracker) *NullableOTCWarningProcessingSpansTracker {
	return &NullableOTCWarningProcessingSpansTracker{value: val, isSet: true}
}

func (v NullableOTCWarningProcessingSpansTracker) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOTCWarningProcessingSpansTracker) UnmarshalJSON(src []byte) error {
	v.isSet = true
