...
func (o *CollectionCloudWatchListMetricsDeniedTracker) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varCollectionCloudWatchListMetricsDeniedTracker)
