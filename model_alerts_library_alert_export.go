...
var _ MappedNullable = &AlertsLibraryAlertExport{}
...
func (o AlertsLibraryAlertExport) ToMap() (map[string]interface{}, error) {
...
func (o *AlertsLibraryAlertExport) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varAlertsLibraryAlertExport)
