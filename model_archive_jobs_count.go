...
var _ MappedNullable = &ArchiveJobsCount{}
...
func (o ArchiveJobsCount) ToMap() (map[string]interface{}, error) {
...
func (o *ArchiveJobsCount) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varArchiveJobsCount)
