...
func (o *PagerDuty) UnmarshalJSON(bytes []byte) (err error) {
	...
	varPagerDuty := _PagerDuty{}

	err = json.Unmarshal(bytes, &varPagerDuty)

	if err != nil {
		return err
	}

	*o = PagerDuty(varPagerDuty)
