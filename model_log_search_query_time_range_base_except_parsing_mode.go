...
func (o *LogSearchQueryTimeRangeBaseExceptParsingMode) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varLogSearchQueryTimeRangeBaseExceptParsingMode)
