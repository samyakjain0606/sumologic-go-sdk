...
func (o *DataForwardingRule) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varDataForwardingRule)
...
type NullableDataForwardingRule struct {
	value *DataForwardingRule
	isSet bool
}

func (v NullableDataForwardingRule) Get() *DataForwardingRule {
	return v.value
}

func (v *NullableDataForwardingRule) Set(val *DataForwardingRule) {
	v.value = val
	v.isSet = true
}

func (v NullableDataForwardingRule) IsSet() bool {
	return v.isSet
}

func (v *NullableDataForwardingRule) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDataForwardingRule(val *DataForwardingRule) *NullableDataForwardingRule {
	return &NullableDataForwardingRule{value: val, isSet: true}
}

func (v NullableDataForwardingRule) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDataForwardingRule) UnmarshalJSON(src []byte) error {
	v.isSet = true
