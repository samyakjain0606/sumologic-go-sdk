...
func (o *CollectionCloudWatchGetStatisticsThrottledTracker) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varCollectionCloudWatchGetStatisticsThrottledTracker)
