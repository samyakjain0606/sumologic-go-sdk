...
func (o *MetricsMetadataTotalMetadataSizeLimitExceeded) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varMetricsMetadataTotalMetadataSizeLimitExceeded)
