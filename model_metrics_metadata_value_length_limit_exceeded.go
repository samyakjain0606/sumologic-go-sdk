...
var _ MappedNullable = &MetricsMetadataValueLengthLimitExceeded{}
...
func NewMetricsMetadataValueLengthLimitExceeded(trackerId string, error_ string, description string) *MetricsMetadataValueLengthLimitExceeded {
	this := MetricsMetadataValueLengthLimitExceeded{}
...
func (o MetricsMetadataValueLengthLimitExceeded) ToMap() (map[string]interface{}, error) {
...
func (o *MetricsMetadataValueLengthLimitExceeded) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varMetricsMetadataValueLengthLimitExceeded)
...
type NullableMetricsMetadataValueLengthLimitExceeded struct {
	value *MetricsMetadataValueLengthLimitExceeded
	isSet bool
}

func (v NullableMetricsMetadataValueLengthLimitExceeded) Get() *MetricsMetadataValueLengthLimitExceeded {
	return v.value
}

func (v *NullableMetricsMetadataValueLengthLimitExceeded) Set(val *MetricsMetadataValueLengthLimitExceeded) {
	v.value = val
	v.isSet = true
}

func (v NullableMetricsMetadataValueLengthLimitExceeded) IsSet() bool {
	return v.isSet
}

func (v *NullableMetricsMetadataValueLengthLimitExceeded) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMetricsMetadataValueLengthLimitExceeded(val *MetricsMetadataValueLengthLimitExceeded) *NullableMetricsMetadataValueLengthLimitExceeded {
	return &NullableMetricsMetadataValueLengthLimitExceeded{value: val, isSet: true}
}

func (v NullableMetricsMetadataValueLengthLimitExceeded) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMetricsMetadataValueLengthLimitExceeded) UnmarshalJSON(src []byte) error {
	v.isSet = true
