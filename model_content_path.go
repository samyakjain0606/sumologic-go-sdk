...
// checks if the ContentPath type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ContentPath{}
...
func (o ContentPath) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["path"] = o.Path
	return toSerialize, nil
}

func (o *ContentPath) UnmarshalJSON(bytes []byte) (err error) {
	...
	varContentPath := _ContentPath{}

	err = json.Unmarshal(bytes, &varContentPath)

	if err != nil {
		return err
	}

	*o = ContentPath(varContentPath)
