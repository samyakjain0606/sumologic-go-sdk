...
type _UsageDetails UsageDetails
...
func (o *UsageDetails) UnmarshalJSON(bytes []byte) (err error) {
	...
	varUsageDetails := _UsageDetails{}

	err = json.Unmarshal(bytes, &varUsageDetails)

	if err != nil {
		return err
	}

	*o = UsageDetails(varUsageDetails)
