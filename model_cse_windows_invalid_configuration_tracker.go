...
var _ MappedNullable = &CSEWindowsInvalidConfigurationTracker{}
...
func (o CSEWindowsInvalidConfigurationTracker) ToMap() (map[string]interface{}, error) {
...
func (o *CSEWindowsInvalidConfigurationTracker) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varCSEWindowsInvalidConfigurationTracker)
