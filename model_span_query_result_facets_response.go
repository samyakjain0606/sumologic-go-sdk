...
var _ MappedNullable = &SpanQueryResultFacetsResponse{}
...
func (o *SpanQueryResultFacetsResponse) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varSpanQueryResultFacetsResponse)
