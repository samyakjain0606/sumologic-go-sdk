...
func (o *CollectionAwsInventoryUnauthorizedTracker) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varCollectionAwsInventoryUnauthorizedTracker)
