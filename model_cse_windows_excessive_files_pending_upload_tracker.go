...
func (o *CSEWindowsExcessiveFilesPendingUploadTracker) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varCSEWindowsExcessiveFilesPendingUploadTracker)
