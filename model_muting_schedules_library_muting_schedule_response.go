...
func (o *MutingSchedulesLibraryMutingScheduleResponse) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varMutingSchedulesLibraryMutingScheduleResponse)
