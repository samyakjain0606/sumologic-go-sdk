...
type _SpanQueryResultSpansResponse SpanQueryResultSpansResponse
...
func (o *SpanQueryResultSpansResponse) UnmarshalJSON(bytes []byte) (err error) {
	...
	varSpanQueryResultSpansResponse := _SpanQueryResultSpansResponse{}

	err = json.Unmarshal(bytes, &varSpanQueryResultSpansResponse)

	if err != nil {
		return err
	}

	*o = SpanQueryResultSpansResponse(varSpanQueryResultSpansResponse)
