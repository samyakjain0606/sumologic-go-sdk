...
func (o *MetricsMetadataTotalMetadataSizeLimitExceededTracker) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varMetricsMetadataTotalMetadataSizeLimitExceededTracker)
