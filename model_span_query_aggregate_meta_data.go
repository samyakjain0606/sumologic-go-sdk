...
// checks if the SpanQueryAggregateMetaData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SpanQueryAggregateMetaData{}
...
func (o *SpanQueryAggregateMetaData) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varSpanQueryAggregateMetaData)
