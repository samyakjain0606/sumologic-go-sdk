...
var _ MappedNullable = &CollectionS3GetObjectAccessDeniedTracker{}
...
func NewCollectionS3GetObjectAccessDeniedTracker(trackerId string, error_ string, description string) *CollectionS3GetObjectAccessDeniedTracker {
	this := CollectionS3GetObjectAccessDeniedTracker{}
...
func (o CollectionS3GetObjectAccessDeniedTracker) MarshalJSON() ([]byte, error) {
...
func (o CollectionS3GetObjectAccessDeniedTracker) ToMap() (map[string]interface{}, error) {
...
func (o *CollectionS3GetObjectAccessDeniedTracker) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varCollectionS3GetObjectAccessDeniedTracker)
...
type NullableCollectionS3GetObjectAccessDeniedTracker struct {
	value *CollectionS3GetObjectAccessDeniedTracker
	isSet bool
}

func (v NullableCollectionS3GetObjectAccessDeniedTracker) Get() *CollectionS3GetObjectAccessDeniedTracker {
	return v.value
}

func (v *NullableCollectionS3GetObjectAccessDeniedTracker) Set(val *CollectionS3GetObjectAccessDeniedTracker) {
	v.value = val
	v.isSet = true
}

func (v NullableCollectionS3GetObjectAccessDeniedTracker) IsSet() bool {
	return v.isSet
}

func (v *NullableCollectionS3GetObjectAccessDeniedTracker) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCollectionS3GetObjectAccessDeniedTracker(val *CollectionS3GetObjectAccessDeniedTracker) *NullableCollectionS3GetObjectAccessDeniedTracker {
	return &NullableCollectionS3GetObjectAccessDeniedTracker{value: val, isSet: true}
}

func (v NullableCollectionS3GetObjectAccessDeniedTracker) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCollectionS3GetObjectAccessDeniedTracker) UnmarshalJSON(src []byte) error {
	v.isSet = true
