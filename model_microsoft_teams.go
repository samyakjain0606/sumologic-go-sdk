...
type _MicrosoftTeams MicrosoftTeams
...
func (o *MicrosoftTeams) UnmarshalJSON(bytes []byte) (err error) {
	...
	varMicrosoftTeams := _MicrosoftTeams{}

	err = json.Unmarshal(bytes, &varMicrosoftTeams)

	if err != nil {
		return err
	}

	*o = MicrosoftTeams(varMicrosoftTeams)
