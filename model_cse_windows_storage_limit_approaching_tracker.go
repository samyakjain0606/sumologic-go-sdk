...
func (o *CSEWindowsStorageLimitApproachingTracker) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varCSEWindowsStorageLimitApproachingTracker)
