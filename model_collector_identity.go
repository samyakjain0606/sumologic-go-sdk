...
type _CollectorIdentity CollectorIdentity
...
func (o *CollectorIdentity) UnmarshalJSON(bytes []byte) (err error) {
	...
	varCollectorIdentity := _CollectorIdentity{}

	err = json.Unmarshal(bytes, &varCollectorIdentity)

	if err != nil {
		return err
	}

	*o = CollectorIdentity(varCollectorIdentity)
