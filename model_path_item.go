...
func (o *PathItem) UnmarshalJSON(bytes []byte) (err error) {
	...
	varPathItem := _PathItem{}

	err = json.Unmarshal(bytes, &varPathItem)

	if err != nil {
		return err
	}

	*o = PathItem(varPathItem)
