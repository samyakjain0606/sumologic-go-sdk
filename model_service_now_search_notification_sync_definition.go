...
func (o *ServiceNowSearchNotificationSyncDefinition) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varServiceNowSearchNotificationSyncDefinition)
