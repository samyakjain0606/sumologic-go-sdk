...
var _ MappedNullable = &AlertsLibraryAlertResponse{}
...
func NewAlertsLibraryAlertResponse(id string, name string, description string, version int64, createdAt time.Time, createdBy string, modifiedAt time.Time, modifiedBy string, parentId string, contentType string, type_ string, isSystem bool, isMutable bool) *AlertsLibraryAlertResponse {
	this := AlertsLibraryAlertResponse{}
	this.Id = id
	this.Name = name
...
func (o AlertsLibraryAlertResponse) ToMap() (map[string]interface{}, error) {
...
func (o *AlertsLibraryAlertResponse) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varAlertsLibraryAlertResponse)
...
type NullableAlertsLibraryAlertResponse struct {
	value *AlertsLibraryAlertResponse
	isSet bool
}

func (v NullableAlertsLibraryAlertResponse) Get() *AlertsLibraryAlertResponse {
	return v.value
}

func (v *NullableAlertsLibraryAlertResponse) Set(val *AlertsLibraryAlertResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAlertsLibraryAlertResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAlertsLibraryAlertResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAlertsLibraryAlertResponse(val *AlertsLibraryAlertResponse) *NullableAlertsLibraryAlertResponse {
	return &NullableAlertsLibraryAlertResponse{value: val, isSet: true}
}
