...
func (o *LogSearchParameterAutoCompleteSyncDefinition) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varLogSearchParameterAutoCompleteSyncDefinition)
