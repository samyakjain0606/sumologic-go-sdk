...
func (o *OTCExporterHighFailuresExportingSpansTracker) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varOTCExporterHighFailuresExportingSpansTracker)
