...
type _MonitorsLibraryMonitorUpdate MonitorsLibraryMonitorUpdate
...
// SetRunAs gets a reference to the given RunAs and assigns it to the RunAs field.
...
func (o *MonitorsLibraryMonitorUpdate) UnmarshalJSON(bytes []byte) (err error) {
	...
	varMonitorsLibraryMonitorUpdate := _MonitorsLibraryMonitorUpdate{}

	err = json.Unmarshal(bytes, &varMonitorsLibraryMonitorUpdate)

	if err != nil {
		return err
	}

	*o = MonitorsLibraryMonitorUpdate(varMonitorsLibraryMonitorUpdate)
